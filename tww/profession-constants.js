...
const CRAFTING_MAP = {
	[PROFESSIONS.Alchemy]: {
		...
		[CATEGORIES.Reagent]: { [CRAFTERS.Sett]: ["Petal Powder", "Bubbling Mycobloom Culture"] },
	},
	[PROFESSIONS.Blacksmithing]: {
		[CATEGORIES.Consumable]: { [CRAFTERS.Taric]: ["Ironclaw Weightstone", "Ironclaw Whetstone", "Ironclaw Razorstone"] },
		[CATEGORIES.Gear]: {
		...
		[CATEGORIES.Reagent]: { [CRAFTERS.Garen]: ["Sanctified Alloy"] },
	},
	[PROFESSIONS.Cooking]: { [CRAFTERS.Sett]: ["Feast of the Midnight Masquerade", "Feast of the Divine Day", "The Sushi Special"] },
	[PROFESSIONS.Enchanting]: {
		...
		[CATEGORIES.Gear]: { [CRAFTERS.Lux]: ["Scepter of Radiant Magics"] },
		[CATEGORIES.ProfessionEquipment]: { [CRAFTERS.Lux]: ["Runed Null Stone Rod", "Runed Ironclaw Rod"] },
		[CATEGORIES.Reagent]: { [CRAFTERS.Karma]: ["Mirror Powder", "Concentration Concentrate"] },
		[CATEGORIES.Other]: {
			[CRAFTERS.Karma]: [
	...
	[PROFESSIONS.Engineering]: {
		...
		[CATEGORIES.GemsTinkers]: { [CRAFTERS.Nasus]: ["Tinker: Earthen Delivery Drill", "Tinker: Heartseeking Health Injector"] },
		[CATEGORIES.ProfessionEquipment]: {
			[CRAFTERS.Pyke]: [
		...
		[CATEGORIES.Other]: { [CRAFTERS.Rengar]: ["22H Slicks"] },
	},
	[PROFESSIONS.Inscription]: {
		...
		[CATEGORIES.Gear]: { [CRAFTERS.Volibear]: ["Vagabond's Bounding Baton", "Vagabond's Careful Crutch", "Vagabond's Torch"] },
		[CATEGORIES.ProfessionEquipment]: { [CRAFTERS.Ryze]: ["Patient Alchemists's Mixing Rod", "Inscribed Rolling Pin", "Silver Tongue's Quill"] },
		[CATEGORIES.Reagent]: {
	...
	[PROFESSIONS.Tailoring]: {
		...
		[CATEGORIES.Gear]: {
			...
			[CRAFTERS.LeBlanc]: ["Warm Sunrise Bracers", "Cool Sunset Bracers", "Consecrated Cuffs"],
			[CRAFTERS.Lux]: [
				"Consecrated Cloak",
				"Consecrated Hood",
			...
			[CRAFTERS.Genianna]: ["Consecrated Cord", "Consecrated Mantle"],
		},
		[CATEGORIES.GemsTinkers]: {
			[CRAFTERS.Lux]: [
		...
		[CATEGORIES.Reagent]: {
			...
			[CRAFTERS.Soraka]: ["Dawnthread Lining", "Duskthread Lining"],
			[CRAFTERS.Lissandra]: [
			...
			[CRAFTERS.Hera]: ["Daybreak Spellthread", "Sunset Spellthread", "Weavercloth Spellthread"],
		},
	},
};
